...
/**
 * <p>
 * <code>Pluralizer</code> converts singular word forms to their plural forms. Methods that are passed <code>null</code> must throw a
...
public interface Pluralizer {
	...
	/**
	 * <p>
	 * Converts a word to its plural form for the given number of instances. Some languages (such as <a
	 * href="http://en.wikipedia.org/wiki/Dual_grammatical_number">Polish</a>) have different plural forms depending on the number of things
	 * being referred to.
	 * </p>
	 * <p>
	 * The return value is not defined if this method is passed a plural form.
