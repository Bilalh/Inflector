...
public class RegexReplacementRule extends AbstractRegexReplacementRule {
	 ...
	 * @param replacement the string to use during replacement. The replacement string may contain references to subsequences captured
	 *            matching. See {@link Matcher#appendReplacement}.
	 */
