...
/**
 * <p>
 * An abstract rule specified using a regular expression and replacement. Subclasses must implement {@link #replace} to perform the actual
 * replacement.
 * </p>
 * 
 * @author Tom White
...
public abstract class AbstractRegexReplacementRule implements Rule {
	...
	/**
	 * <p>
	 * Form the disjunction of the given regular expression patterns. For example if patterns contains "a" and "b" then the disjunction is
	 * "(a|b)", that is, "a or b".
	 * </p>
	 * 
