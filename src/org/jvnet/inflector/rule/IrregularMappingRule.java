...
/**
 * <p>
 * A rule for specifying an irregular inflection using a combination of a map of singular to plural forms and a regular expression
 * replacement. Subclasses cn implement {@link #replace} to perform the actual replacement, which by default uses the map to substitute a
 * plural form for the corresponding singular form found in group 0 of the regular expression match.
 * </p>
 * 
 * @author Tom White
 */
public class IrregularMappingRule extends AbstractRegexReplacementRule {
	 ...
	 * @param regex the regular expression used to match words. Match information is available to subclasses in the {@link #replace} method.
	 */
