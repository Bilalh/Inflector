 ...
 * </p>
 * <p>
 * This code is based on <a href="http://search.cpan.org/dist/Lingua-EN-Inflect/lib/Lingua/EN/Inflect.pm">Lingua::EN::Inflect</a>, which is
 * Copyright (c) 1997-2000, Damian Conway.
 * </p>
 * 
 * @author Tom White
 */
public class NounPluralizer extends RuleBasedPluralizer {
	...
	private final List<Rule> rules = Arrays.asList(new Rule[] {
			...
			// FIXME changed  so that Enemy -> Enemies works 
